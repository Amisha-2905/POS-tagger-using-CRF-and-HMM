...
with open('Hindi_data.txt', 'r') as input_file:
    data = input_file.read()
    data = data.replace('\tNN','\tN_NN')
    data = data.replace('\tNST','\tN_NST')
    data = data.replace('\tNNP','\tN_NNP')
    data = data.replace('QT_QT_QTC','QT_QTC')
    data = data.replace('\tINTF','\tRP_INTF')
    data = data.split('\n')
...
with open('Hindi_Annotations.txt', 'r') as file:
    data = file.read()
    data = data.split('\n')
...
with open('Hindi_output_hmm.txt', 'w') as output_file:
    sentence = 0
